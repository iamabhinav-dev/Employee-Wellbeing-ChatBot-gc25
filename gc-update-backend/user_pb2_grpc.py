...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateAtSOD = channel.unary_unary(
                ...
                request_serializer=user__pb2.UpdateAtSODRequest.SerializeToString,
                response_deserializer=user__pb2.UpdateAtSODResponse.FromString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UpdateAtSOD': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.UpdateAtSODRequest.FromString,
                    response_serializer=user__pb2.UpdateAtSODResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def UpdateAtSOD(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserService/UpdateAtSOD',
            user__pb2.UpdateAtSODRequest.SerializeToString,
            user__pb2.UpdateAtSODResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
